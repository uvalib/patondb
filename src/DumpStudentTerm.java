...
public class DumpStudentTerm {
    ...
    static final Logger logger  = LogManager.getLogger(DumpStudentTerm.class.getName());

    public DumpStudentTerm() {
    ...
    private void loadSISData(PrintWriter studentTermWriter, String selectTerm) {
		...
		"(SELECT  ",
			...
			"WHERE ",
        			"term = ?  ",
			"GROUP BY student_system_id, term, term_desc )  ",
...
*/
	...
	DumpStudentTerm myLoad = new DumpStudentTerm();
/*      
